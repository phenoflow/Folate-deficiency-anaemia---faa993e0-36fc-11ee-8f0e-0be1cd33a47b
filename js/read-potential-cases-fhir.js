...
(async () => {
  ...
  await fs.writeFile("folate-deficiency-anaemia-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("folate-deficiency-anaemia-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
